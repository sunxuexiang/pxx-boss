...
export default class CompanyActor extends Actor {
   ...
   * @param managerList
   */
  @Action('company: managerList')
  managerList(state: IMap, managerList) {
   ...
   * @param managerList
   */
  @Action('company: marketsList')
  marketsList(state: IMap, marketsList) {
    return state.set('marketsList', marketsList);
  }
}
