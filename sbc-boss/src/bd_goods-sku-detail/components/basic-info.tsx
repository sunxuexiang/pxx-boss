      ...
      <div>
        ...
        <div style={{ marginTop: 20 }}>
          ...
          <Form style={{ marginTop: 20 }}>
            ...
            <Row>
              <Col span={8}>
                <FormItem {...formItemLayout} label="划线价" required={true}>
                  <div>{QMFloat.addZero(goods.get('retailPrice'))}</div>
                </FormItem>
              </Col>
            </Row>
            <Row>
            ...
            <Row>
              <Col span={8}>
                <FormItem {...formItemLayout} label="整箱规格" required={true}>
                  <div>1箱={goods.get('fullStep')}瓶</div>
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col span={8}>
                <FormItem {...formItemLayout} label="设置散批规格" required={true}>
                  <div>1份={goods.get('addStep')}瓶</div>
                </FormItem>
              </Col>
            </Row>
            {/* <Row>
