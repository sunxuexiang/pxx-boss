...
export default class AppStore extends Store {
  ...
  init = async () => {
    ...
    if (code === Const.SUCCESS_CODE) {
      this.dispatch('ModalActor: privacyPolicyPop', context.privacyPolicyPop);
      this.dispatch('ModalActor: privacyPolicy', context.privacyPolicy);
      this.dispatch('FormActor: privacyPolicyId', context.privacyPolicyId);
    } else {
