      ...
      <div className="template-manage-main">
        <div className="ant-layout-sider">
          ...
          >
            ...
            {platform === 'weixin' && (
              <Menu.Item key="classify">分类页</Menu.Item>
            )}
          </Menu>
        </div>
        <div className="template-manage-content">
          {platform == 'weixin' && includePageTypeList == 'index' && (
            <a
              href="javascript:void(0);"
              onClick={isSystem(() => {
                window.open(
                  `${Const.X_XITE_ADMIN_HOST}/uerTpl/edit?id=weixin-wechat&type=blank&sc=H4sIAAAAAAAAA0sxSg4uyS9KBQDJOKt4CAAAAA==`
                );
              })}
            >
