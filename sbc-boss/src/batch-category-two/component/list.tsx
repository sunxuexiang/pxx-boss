...
class list extends Component<any, any> {
    ...
    render() {
                ...
                render: ((res) => {
                    return (
                        <div>
                             ...
                             onClick={() =>  {this._deleteIt(res)}} > 移除 </Button>
                        </div>
                    )
                })
            },
        ...
        return (
            <div>
                <SearchForm onischoun={this.ontrueas} seacher={(val)=>{this.init(pageNum,pageSize,val)}} Imageget={Imageget} batchDelete={this.batchDelete} />
                <Table rowSelection={{
   ...
   */
    ...
    skuSelectedBackFun = async (selectedSkuIds, selectedRows) => {
        console.log(selectedSkuIds, selectedRows.toJS(), 'selectedSkuIds, selectedRows');
        const { pageNum, pageSize } = this.state;
...
*/
    closeGoodsModal = () => {
        console.log(this.state.goodsModal, '99999')
