...
export default class GoodsModal extends React.Component<any, any> {
  ...
  constructor(props) {
    super(props);
    console.log(props.selectedSkuIds,'props.selectedSkuIdsprops.selectedSkuIds');
  ...
  componentWillReceiveProps(nextProps) {
    console.log(nextProps.selectedSkuIds,'props.selectedSkuIdsprops.selectedSkuIds123');
  ...
  render() {
    ...
    return (
      <Modal  maskClosable={false}
        ...
        visible={visible}
        onOk={() => {
          console.log(this.state.selectedSkuIds, this.state.selectedRows,'this.state.selectedSkuIds, this.state.selectedRows');
          if(this.state.selectedRows.length <= 10) {
