...
export default class ResourceForm extends React.Component<any, any> {
  _store: Store;
  ...
  render() {
    ...
    const resourceForm = _state.get('resourceForm');

    let endPoint = {
      initialValue: resourceForm.get('endPoint')
    };
    let accessKeyId = {
      initialValue: resourceForm.get('accessKeyId')
    };
    let accessKeySecret = {
      initialValue: resourceForm.get('accessKeySecret')
    };
    let bucketName = {
      initialValue: resourceForm.get('bucketName')
    };
    let region = {
      initialValue: resourceForm.get('region')
    };
