 ...
 * @param filterParams
 */
export function fetchCustomerChilidList(filterParams = {}) {
  return Fetch<TResult>('/customer/pageByChild', {
    method: 'POST',
    body: JSON.stringify({
      ...filterParams
    })
 ...
 * @param filterParams
 */
export function bindChildAccount(filterParams) {
  return Fetch<TResult>('/workorderdetail/bindChildAccount', {
    method: 'POST',
    body: JSON.stringify({
      ...filterParams
    })
