...
export default class SearchForm extends React.Component<any, any> {
        ...
        <Form className="filter-content" layout="inline">
          ...
          <FormItem>
            <SelectGroup
              getPopupContainer={() => document.getElementById('page-content')}
              label="店铺名称"
              value={LiveGoodsSearchData.get('goodsType')}
              onChange={(value) => {
                console.log(value);
                onSearchLiveGoods('goodsType', value);
              }}
            >
              <Select.Option key="0" value="0">
                大白鲸
          ...
          <FormItem>
            <Button
              ...
              onClick={() => {
                onGoodsChange(
                  'goodsTypes',
                  Number(LiveGoodsSearchData.get('goodsType'))
                );
                queryLiveGoodsPage();
              }}
            >
  ...
  skuSelectedBackFun = async (
    ...
    onAddGoodsChange(fromJS([...new Set(selectedSkuIdsList)]), goodsType);
  };
