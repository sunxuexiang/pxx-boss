    ...
    _columns:any = [
        {
          ...
          },
          {
            ...
            align: 'left',
            render: (text, row) => {
              return <div>{row.couponActivity.receiveType
          ...
          },
          {
            ...
            align: 'left',
            render: (text,row) => {
              return <div>{row.couponActivity.joinLevel == '-1' ? '全平台客户' : '其他'}</div>;
            }
          },
          {
            key: 'pauseFlag',
                    ...
                    rowSelection={{
                            ...
                            onChange: (selectedRowKeys, selectedRows) => {
                                ...
                                if(selectedRowKeys.length>1){
                                    ...
                                    editFormData('activityId',selectedRowKeys.length?record.couponActivity.activityId:null);
                            ...
                            getCheckboxProps: (record1:any) => {
                                ...
                                return { 
                                    disabled: list.length==1&&list[0]!=record1.couponId?true:false, 
