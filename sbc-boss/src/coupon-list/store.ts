...
export default class AppStore extends Store {
  ...
  onWareHousePage = async () => {
    // let {res}:any=await webapi.wareHousePage({pageNum:0,pageSize:10000});
    // if(res.code===Const.SUCCESS_CODE){
    //   this.dispatch('start-form', { key: 'warehouseList', value: fromJS(res.context?.wareHouseVOPage?.content||[]) });
    // }else{
