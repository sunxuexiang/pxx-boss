...
*/
  ...
  editInit = async (wareId,advertisingId) => {
    ...
    if (res.code == Const.SUCCESS_CODE) {
      ...
      activity.jumpLink1.isSuit1 = homeacTive.advertisingConfigList[1] ? homeacTive.advertisingConfigList[1].isSuit ? homeacTive.advertisingConfigList[1].isSuit : 0 : 0;
      activity.jumpLink2.isSuit2 = homeacTive.advertisingConfigList[2] ? homeacTive.advertisingConfigList[2].isSuit ? homeacTive.advertisingConfigList[2].isSuit : 0 : 0;
      activity.jumpLink3.isSuit3 = homeacTive.advertisingConfigList[3] ? homeacTive.advertisingConfigList[3].isSuit ? homeacTive.advertisingConfigList[3].isSuit : 0 : 0;
      activity.jumpLink4.isSuit4 = homeacTive.advertisingConfigList[4] ? homeacTive.advertisingConfigList[4].isSuit ? homeacTive.advertisingConfigList[4].isSuit : 0 : 0;
      ...
      if (homeacTive.advertisingConfigList[2]) {
        ...
        activity.imageUrl2 = homeacTive.advertisingConfigList[2].advertisingImage;
      }
      if (homeacTive.advertisingConfigList[3]) {
        ...
        activity.imageUrl3 = homeacTive.advertisingConfigList[3].advertisingImage;
      ...
      if (homeacTive.advertisingConfigList[4]) {
        ...
        activity.imageUrl4 = homeacTive.advertisingConfigList[4].advertisingImage;
  ...
  save = async () => {
    ...
    if (imageList.length > 0) {
      advertisingConfigList.push({
        ...
        jumpLink: '',
        advertisingId: activity.advertisingId ? activity.advertisingConfigList[0].advertisingId : null,
        advertisingConfigId: activity.advertisingId ? activity.advertisingConfigList[0].advertisingId : null,
    ...
    if (imageList1.length > 0) {
      advertisingConfigList.push({
        ...
        jumpLink: '',
        advertisingId: activity.advertisingConfigList[1] ? activity.advertisingConfigList[1].advertisingId : null,
        advertisingConfigId: activity.advertisingConfigList[1] ? activity.advertisingConfigList[1].advertisingId : null,
        moFangAdvertisingName: activity.jumpLink1 ? activity.jumpLink1.title : '',
    ...
    if (imageList2.length > 0) {
      advertisingConfigList.push({
        advertisingImage: imageList2[0] ? imageList2[0].response ? imageList2[0].response[0] : imageList2[0].url : '',
        jumpLink: '',
        advertisingId: activity.advertisingConfigList[2] ? activity.advertisingConfigList[2].advertisingId : null,
        advertisingConfigId: activity.advertisingConfigList[2] ? activity.advertisingConfigList[2].advertisingId : null,
        moFangAdvertisingName: activity.jumpLink2 ? activity.jumpLink2.title : '',
    ...
    if (imageList3.length > 0) {
      advertisingConfigList.push({
        advertisingImage: imageList3[0] ? imageList3[0].response ? imageList3[0].response[0] : imageList3[0].url : '',
        jumpLink: '',
        advertisingId: activity.advertisingConfigList[3] ? activity.advertisingConfigList[3].advertisingId : null,
        advertisingConfigId: activity.advertisingConfigList[3] ? activity.advertisingConfigList[3].advertisingId : null,
        moFangAdvertisingName: activity.jumpLink3 ? activity.jumpLink3.title : '',
    ...
    if (imageList4.length > 0) {
      advertisingConfigList.push({
        advertisingImage: imageList4[0] ? imageList4[0].response ? imageList4[0].response[0] : imageList4[0].url : '',
        jumpLink: '',
        advertisingId: activity.advertisingConfigList[4] ? activity.advertisingConfigList[4].advertisingId : null,
        advertisingConfigId: activity.advertisingConfigList[4] ? activity.advertisingConfigList[4].advertisingId : null,
        moFangAdvertisingName: activity.jumpLink4 ? activity.jumpLink4.title : '',
    ...
    console.log(advertisingConfigList, 'advertisingConfigListadvertisingConfigList');
    params.advertisingConfigList = advertisingConfigList.length > 0 ? advertisingConfigList : []
    // 3.提交
    let res = null;
