...
import { DataGrid, noop, Const, isSystem, history } from 'qmkit';
      ...
      >
        <Column
          ...
          render={(title, info: any) => {
            let isClassifyDefault =
              includePageTypeList.get(0) === 'classify' &&
              info.pageCode == '1619149737870';
            return title ? (
              <div className="title-input">
                ...
                {isClassifyDefault && (
                  <span>
                    <span className="let-triangle" />
                    <span className="tpl-use">默认</span>
                  </span>
                )}
                <span>
                  {' '}
        ...
        <Column
          ...
          render={(rowInfo) => {
            ...
            let isClassifyDefault =
              includePageTypeList.get(0) === 'classify' &&
              rowInfo.pageCode == '1619149737870';
            return (
              <div>
                {!isClassifyDefault && (
                  <a
