  ...
  render() {
    ...
    const props = {
      ...
      beforeUpload: (file) => {
        ...
        return this._checkUploadFile(file)
          ? this._checkUploadFile(file)
          : false;
      },
      headers: {
      ...
      async onChange(info) {
        ...
        if (info.file.status === 'done') {
          let backGroundPic = await _this.getBase64(info.file.originFileObj);
          changeFieldInfo('backGroundPic', backGroundPic);
