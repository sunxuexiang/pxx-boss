            ...
            <div className="right-state">
                    ...
                    <RangePicker
                      ...
                      value={
                        ...
                        endTime === ''
                          ? null
                          : [
                              momnet(beginTime, dateFormat),
                              momnet(endTime, dateFormat)
                            ]
                      }
                ...
                <div className="from-usage">
                  <div className="form-position ">
                    <Input
                      ...
                      value={popupName}
                      onChange={(e) =>
                        this._store.onChangePopupName(e.target.value)
                      }
                    />
              ...
              {/* <AuthWrapper functionName={'f_points_setting_edit'}> */}
                <div className="bar-button">
                  <Button
                    type="primary"
                    onClick={() => submit({ popupName: this.state.popupName })}
                  >
                    保存
                  </Button>
                </div>
