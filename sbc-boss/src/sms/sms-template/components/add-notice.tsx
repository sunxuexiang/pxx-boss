...
import AddNoticeForm from './add-notice-form';

const WrappedTemplateForm = Form.create({})(AddNoticeForm);

@Relax
export default class AddNotice extends React.Component<any, any> {
  _form: any;
