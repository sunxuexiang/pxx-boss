...
export default class GoodsList extends React.Component<any, any> {
  ...
  render() {
    ...
    const oid = detail.get('ptid');
    const storeName = detail.getIn(['tradeVO', 'supplier', 'supplierName']);
    const storeId = detail.getIn(['tradeVO', 'supplier', 'supplierCode']);
    // sku list
        ...
        <div style={styles.detailBox as any}>
          ...
          <div style={styles.priceBox}>
            ...
            <label style={styles.priceItem as any}>
              ...
              <strong>{applyPoints ? applyPoints : 0}</strong>
            </label>
            <label style={styles.priceItem as any}>
            ...
            {refundStatus === 2 && (
              <label style={styles.priceItem as any}>
                ...
                <strong>{actualPoints ? actualPoints : 0}</strong>
              </label>
            )}
          </div>
        </div>
