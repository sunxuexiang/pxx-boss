    ...
    return (
      ...
      >
        ...
        <Column
          ...
          key="goodsId"
          render={(rowInfo) => {
            return checkAuth('f_bd_goods_detail_1') ||
              checkAuth('f_bd_goods_2') ||
              checkAuth('f_bd_add_to_goods_library_1') ? (
              <div>
                <div>
                  <AuthWrapper functionName="f_bd_goods_edit_sort">
                    <a
                      href="javascript:;"
                  ...
                  <AuthWrapper functionName="f_bd_goods_detail_1">
                    <Link
                      to={`/bd_goods-detail/${rowInfo.goodsId}/${pageNum}`}
                      style={{ marginRight: 10 }}
                    >
                      查看
                    </Link>
                ...
                <AuthWrapper functionName="f_bd_add_to_goods_library_1">
        ...
        return (
          <div key={`${index}_${i}`} style={styles.item}>
            <div style={{ marginLeft: 17 }}>
              ...
              />
              <AuthWrapper functionName="f_bd_goods_sku_detail_1">
                <Link
                  style={{ marginTop: 5, display: 'block' }}
                  to={`/bd_goods-sku-detail/${goods.get('goodsInfoId')}`}
                >
                  查看
                </Link>
              </AuthWrapper>
