...
import ShopTradeStatisticsList from './component/shoplist';
import TradeCharts from './component/tradechart';
import Paint from './component/paint';
import { util, DataModal, BreadCrumb } from 'qmkit';
          ...
          <div style={styles.content}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <div style={{ display: 'flex' }}>
                ...
                <DownloadModal
                  visible={false}
                  reportType={this.store.state().get('tabKey') == 1 ? 1 : 13}
            ...
            <div>
              <ul style={styles.box}>
                ...
                {!this.store.state().get('companyInfoId') ? (
                  <li>
                    <a
