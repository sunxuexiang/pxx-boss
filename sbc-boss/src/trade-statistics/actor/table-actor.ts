...
export default class TableActor extends Actor {
  defaultState() {
    return {
      ...
      visible: false,
      tabKey: 1, //按天还是按店铺(1:按天，2:按店铺)
      companyInfoId: null, //1表示平台所有
      selectType: 0 //报表时间段查询枚举
    };
  }
  ...
  selectType(state: IMap, selectType: string) {
