...
/**
 * 确认收货
 * @url /return/supplierReceive
 */
export const supplierReceive = (params) => {
  return Fetch<TResult>('/return/supplierReceive', {
    method: 'POST',
    body: JSON.stringify({
      ...params
    })
 ...
 * @returns {Promise<IAsyncResult<TResult>>}
 */
export const refundOfflineTids = (params = {}) => {
  return Fetch<TResult>('/return/refund/batchOffline', {
    method: 'POST',
    body: JSON.stringify(params)
  });
};
