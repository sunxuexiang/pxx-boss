...
export default class PicActor extends Actor {
   ...
   * @param cateIds
   */
  @Action('enterprise: modal: cateIds')
   ...
   * @param cateId
   */
  @Action('enterprise: modal: cateId')
   ...
   * @param imgCates
   */
  @Action('enterprise: modal: imgCates')
   ...
   */
  @Action('enterprise: modal: search')
   ...
   */
  @Action('enterprise: modal: searchName')
   ...
   * @param {any} img
   */
  @Action('enterprise: modal: chooseImg')
   ...
   * @param imgUrl
   */
  @Action('enterprise: modal: imgVisible')
   ...
   * @param state
   */
  @Action('enterprise: modal: cleanChooseImg')
   ...
   * @param maxCount
   */
  @Action('enterprise: modal: maxCount')
   ...
   * @param successImgs
   */
  @Action('enterprise: modal: chooseImgs')
   ...
   */
  @Action('enterprise: setting: regEditor')
  setRegEditor(state, regEditor) {
