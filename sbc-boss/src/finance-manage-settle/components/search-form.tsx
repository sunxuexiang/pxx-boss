...
export default class SearchForm extends React.Component<any, any> {
        ...
        <Form className="filter-content" layout="inline">
          ...
          <FormItem>
            <AutoComplete
              ...
              onChange={(value) => this._handleOnStoreNameChange(value, storeMap.toJS())}
              allowClear={true}
              placeholder="店铺名称"
            />
          </FormItem>
          <FormItem>
            <Button type="primary" onClick={() => fetchSettleList()} htmlType="submit">
              搜索
            </Button>
          </FormItem>
        </Form>
   ...
   * @private
   */
  _handleOnStoreNameChange = (value, storeMap) => {
