...
@Relax
export default class ReplaceWxModal extends React.Component<any, any> {
  _form;
  GateWaysForm: any;
  ...
  props: {
    relaxProps?: {
      replace_wx_visible: boolean;
      onSaveChannel: Function;
      onCancelReplaceWx: Function;
      channelJson: IMap;
  ...
  static relaxProps = {
    replace_wx_visible: 'replace_wx_visible',
    onSaveChannel: noop,
    onCancelReplaceWx: noop,
    channelJson: 'channelJson',
    onFormValueChange: noop
  };

  render() {
    const { replace_wx_visible, onCancelReplaceWx } = this.props.relaxProps;

    const GateWaysForm = this.GateWaysForm;

    if (!replace_wx_visible) {
      return null;
    }
    return (
      <Modal
