...
import { Alert, Form, Input, Modal, Switch, Tooltip } from 'antd';
                ...
                <tbody>
                  ...
                  {channelValue.get('alipay_qr') ? (
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                  ...
                  {channelValue.get('wx_pub_qr') ? (
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          placement="topRight"
                          title={this._renderExample('wx_pub_qr')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                          title={this._renderExample('upacp_pc')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                          title={this._renderExample('alipay_wap')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                          title={this._renderExample('wx_pub')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                          title={this._renderExample('upacp_wap')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                          title={this._renderExample('alipay')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <Tooltip
                          overlayClassName="pay-modal-content"
                          placement="topRight"
                          title={this._renderExample('upacp')}
                        >
                          <a>示例</a>
                        </Tooltip>
                      </td>
      ...
      <Form>
        ...
        <FormItem {...formItemLayout} label="ping++公钥" required={true}>
          {getFieldDecorator('publicKey', {
            ...
            rules: [
              { required: true, whitespace: true, message: '请输入商户公钥' },
