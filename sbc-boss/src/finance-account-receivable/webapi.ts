...
// 获取所有支付开关
export const getAppPaySwitch = () => {
  return Fetch<TResult>('/appPaySwitch/getAppPaySwitch');
};
// 修改支付开关状态
export const updateAppPaySwitch = (content) => {
  return Fetch<TResult>('/appPaySwitch/updateAppPaySwitch', {
    method: 'POST',
    body: JSON.stringify(content)
  });
};
