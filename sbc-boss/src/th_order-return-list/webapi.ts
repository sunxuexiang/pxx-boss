...
export const fetchOrderReturnList = (filter = {}) => {
  return Fetch<TResult>('/boss/newPileReturnTrade/page', {
    method: 'POST',
...
// export const fetchOrderReturnList = (filter = {}) => {
//   return Fetch<TResult>('/return/pile', {
//     method: 'POST',
//     body: JSON.stringify(filter)
//   });
// };
 ...
 */
 export const refundOffline = (rid:string,params={}) => {
  return Fetch<TResult>(`/boss/newPileReturnTrade/refund/${rid}/offline`, {
    method: 'POST',
...
//   return Fetch<TResult>(`/return/pile/refund/${rid}/closeRefund`, {
//     method: 'POST'
//   });
// };
