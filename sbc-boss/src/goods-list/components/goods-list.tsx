...
import { AuthWrapper, DataGrid, noop, Const, checkAuth, history } from 'qmkit';
...
export default class CateList extends React.Component<any, any> {
    ...
    return (
      ...
      >
            ...
            return (
              <div>
                <p style={styles.vipwidth}>
                  <img
                    style={styles.vipprices}
                    src="https://cjdbj.oss-accelerate.aliyuncs.com/mini/listVip.png"
                  />{' '}
                  ￥
                  {vipPrice == null
        ...
        <Column
          ...
          key="goodsId"
          render={(rowInfo) => {
            return checkAuth('f_goods_detail_1') ||
              checkAuth('f_goods_2') ||
              checkAuth('f_add_to_goods_library_1') ? (
              <div>
                <div>
                  ...
                  <AuthWrapper functionName="f_goods_detail_1">
                    <a
                      ...
                      onClick={() => {
                        ...
                        history.push({
                          pathname: `/goods-detail/${rowInfo.goodsId}/${pageNum}`
                        });
                      }}
                    >
                      查看
                ...
                <AuthWrapper functionName="f_add_to_goods_library_1">
  ...
  _expandedRowRender = (record, index) => {
    ...
    //     width: 95,
    //     render: (img) => (
    //       <img src={img ? img : defaultImg} style={styles.imgItem} />
    //     )
    //   },
    //   {
    //     title: 'SKU编码',
    ...
    //           );
    //           history.push({
    //             pathname: `/goods-detail-third/${text}/${pageNum}`
    //           });
    //         }}
    //       >
    //         查看
    ...
    //           />
    //           <AuthWrapper functionName="f_goods_sku_detail_1">
    //             <a
    //                   href="javascript:;"
    //                   style={{ marginTop: 5, display: 'block' }}
    // onClick={() => {
    //   let searchCacheForm=JSON.parse(sessionStorage.getItem('searchCacheForm'))||{};
    //   sessionStorage.setItem('searchCacheForm',JSON.stringify({...searchCacheForm,goodsForm:searchForm||{}}));
    //   history.push({
    //     pathname: `/goods-sku-detail/${goods.get('goodsInfoId')}`
    //   });
    // }}
    //                 >
    //                   查看
