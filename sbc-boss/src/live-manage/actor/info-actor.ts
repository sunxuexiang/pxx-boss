...
export default class InfoActor extends Actor {
  defaultState() {
    return {
      ...
      formData: {
        ...
        liveCateNames: [], //选择的直播账号名字列表
        //
        operationCateIds: [], //选择的运营账号id列表
        operationCateName: [] //选择的运营账号名字列表
      },
      companyCates: [], //厂商列表
      brandCates: [], //品牌列表
      pageLiveCates: [], //直播账号列表
      operationCates: [], //运营账号列表
      storeList: [] //商家列表
    };
  }
  ...
  @Action('info:storeList')
  setStoreList(state: IMap, storeList) {
