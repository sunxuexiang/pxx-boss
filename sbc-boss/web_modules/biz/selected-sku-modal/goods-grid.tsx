...
export default class GoodsGrid extends React.Component<any, any> {
  ...
  componentDidMount() {
    console.log(this.props.isWare,'isWare')
  ...
  init = async (params) => {
    ...
    // }
    // this.state.tableUrlType=='batch'  请求散批商品列表接口
    let { res }=this.state.showStore? await webapi.retailGoodsSkus({...params}): await webapi.fetchGoodsList({
      ...params
    });
