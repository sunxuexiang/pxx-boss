...
const menuList: Array<MenuType> = [
  ...
  },
  {
    ...
    children: [
      { label: '平台收款账户', path: '/finance-account-receivable' },
      { label: '商家收款账户', path: '/supplier-account' },
      {
        label: '资金管理',
        children: [
          {
          ...
          // { label: '退款明细', path: '/finance-refund-detail' },
          {
            ...
            path: '/finance-manage-check',
            children: [
              { label: '财务对账明细', path: '/finance-manage-refund' }
            ]
          },
      ...
      },
      {
        ...
        children: [
          ...
          { label: '增值税发票', path: '/finance-val-added-tax' }
        ]
      }
      // {
      //   label: '对账报表',
      //   icon: 'http://kstoreimages.b0.upaiyun.com/1496720652755.jpg',
      //   children: [
      //     {
      //       label: '财务对账',
      //       path: '/finance-manage-check',
